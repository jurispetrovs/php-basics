...
function display_board($board): void
{
...
function columnCheck($board): bool
{
    for ($i = 0; $i < 3; $i++) {
...
function diagonalCheck($board): bool
{
